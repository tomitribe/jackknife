...
/**
 * Tests that exercise ServiceA and the provided-scope dependency.
 * When Join.join is instrumented, debug JSON output appears during these tests.
 */
public class ServiceATest {

    @Test
    public void joinWordsViaDep() {
        final ServiceA service = new ServiceA();
        final String result = service.joinWords("a,b,c");
        assertEquals("a and b and c", result);
    }

    @Test
    public void directJoinCall() {
