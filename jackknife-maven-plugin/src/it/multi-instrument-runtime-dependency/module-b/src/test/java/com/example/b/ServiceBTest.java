...
/**
 * Tests that exercise the runtime-scope dependency directly.
 * Runtime deps are on the test classpath, so this test can import Join.
...
public class ServiceBTest {
    ...
    public void greetReturnsMessage() {
        ...
        assertEquals("Hello from B, World!", result);
    }

    @Test
    public void joinFromRuntimeDependency() {
