...
// Verify that jackknife:index creates a manifest for a compile-scope dependency
...
// -- Manifest contains org.tomitribe.util.Join --
def content = utilManifest.text
assert content.contains('org.tomitribe.util.Join') : 'Manifest should contain org.tomitribe.util.Join'

// -- USAGE.md generated --
def usageMd = new File(jackknife, 'USAGE.md')
assert usageMd.exists() : 'USAGE.md should be generated'

println "single-index-compile-dependency verified:"
println "  .jackknife/manifest exists: yes"
println "  tomitribe-util manifest exists: yes"
println "  org.tomitribe.util.Join listed: yes"
