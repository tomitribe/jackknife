...
// Verify that jackknife:index creates a manifest for a provided-scope dependency
...
assert utilManifest != null : 'Should have manifest for tomitribe-util (provided scope should be indexed)'

// -- USAGE.md generated --
def usageMd = new File(jackknife, 'USAGE.md')
assert usageMd.exists() : 'USAGE.md should be generated'

println "single-index-provided-dependency verified:"
